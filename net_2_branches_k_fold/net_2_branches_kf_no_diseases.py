...
wandb.init(project='net_2_branches_kf', tags=['morph-only'])
...
train_loader = DataLoader(dataset, batch_size=wandb.config.batch_size, sampler=train_sampler, num_workers=3)
test_loader = DataLoader(dataset, batch_size=wandb.config.batch_size, sampler=test_sampler, num_workers=3)
